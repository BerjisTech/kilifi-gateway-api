  ...
  test 'should create product_variant' do
    assert_difference('ProductVariant.count') do
      post product_variants_url,
           params: { product_variant: { description: @product_variant.description, name: @product_variant.name, price_difference: @product_variant.price_difference, product_id: @product_variant.product_id } }, as: :json
    end
