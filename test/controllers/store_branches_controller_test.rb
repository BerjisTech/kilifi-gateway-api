...
class StoreBranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create store_branch' do
    assert_difference('StoreBranch.count') do
      post store_branches_url,
           params: { store_branch: { coordinates: @store_branch.coordinates, location_name: @store_branch.location_name, name: @store_branch.name, store_id: @store_branch.store_id } }, as: :json
    end
  ...
  test 'should update store_branch' do
    patch store_branch_url(@store_branch),
          params: { store_branch: { coordinates: @store_branch.coordinates, location_name: @store_branch.location_name, name: @store_branch.name, store_id: @store_branch.store_id } }, as: :json
    assert_response :success
  end
