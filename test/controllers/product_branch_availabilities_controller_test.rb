...
class ProductBranchAvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_branch_availability" do
    assert_difference("ProductBranchAvailability.count") do
      post product_branch_availabilities_url, params: { product_branch_availability: { availability: @product_branch_availability.availability, product_id: @product_branch_availability.product_id, store_branch_id: @product_branch_availability.store_branch_id } }, as: :json
    end
  ...
  test "should update product_branch_availability" do
    patch product_branch_availability_url(@product_branch_availability), params: { product_branch_availability: { availability: @product_branch_availability.availability, product_id: @product_branch_availability.product_id, store_branch_id: @product_branch_availability.store_branch_id } }, as: :json
    assert_response :success
  end
