  ...
  test 'should create store_contact' do
    assert_difference('StoreContact.count') do
      post store_contacts_url,
           params: { store_contact: { contact_email: @store_contact.contact_email, contact_name: @store_contact.contact_name, contact_phone: @store_contact.contact_phone, store_id: @store_contact.store_id } }, as: :json
    end
